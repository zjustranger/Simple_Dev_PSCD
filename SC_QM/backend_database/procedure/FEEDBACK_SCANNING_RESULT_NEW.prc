CREATE OR REPLACE PROCEDURE PSQM.feedback_scanning_result_new (
    p_label       IN     VARCHAR2,
...
IS
    ...
    /******************************************************************************
       ...
       2.0        5/26/2020   CYANG44       2. Update the version to support batch no.
...
EXCEPTION
    ...
    THEN
        ...
        RAISE;
END feedback_scanning_result_new;
/