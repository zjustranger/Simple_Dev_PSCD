CREATE OR REPLACE FUNCTION PSQM.insert_transaction_new (
...
/******************************************************************************
   ...
   2.0        5/26/2020   CYANG44       2. Change this function for the new requirement to add batch no.
